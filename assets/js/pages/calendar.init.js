      ...
      (e.prototype.onSelect = function (t, a, e) {
         ...
         i.append("<div class='row'></div>"),
            ...
            o.$modal.find("form").on("submit", function () {
               ...
               return null !== e && 0 != e.length ? (o.$calendarObj.fullCalendar("renderEvent", { title: e, start: t, end: a, allDay: !1, className: n }, !0), o.$modal.modal("hide")) : alert("You have to give a title to your event"), !1;
            }),
      ...
      (e.prototype.init = function () {
         ...
         (a.$calendarObj = a.$calendar.fullCalendar({
            ...
            this.$saveCategoryBtn.on("click", function () {
               ...
               null !== e &&
                  0 != e.length &&
                  (a.$extEvents.append('<div class="external-event bg-' + n + '" data-class="bg-' + n + '" style="position: relative;"><i class="mdi mdi-checkbox-blank-circle m-r-10 vertical-middle"></i>' + e + "</div>"), a.enableDrag());
            });
      }),
      (l.CalendarApp = new e()),
