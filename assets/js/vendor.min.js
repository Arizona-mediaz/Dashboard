!(function (e, t) {
            ...
            if (null != (e = arguments[a]))
               for (t in e)
                  (i = e[t]),
                     "__proto__" !== t &&
                        s !== i &&
                        (u && i && (C.isPlainObject(i) || (r = Array.isArray(i))) ? ((n = s[t]), (o = r && !Array.isArray(n) ? [] : r || C.isPlainObject(n) ? n : {}), (r = !1), (s[t] = C.extend(u, o, i))) : void 0 !== i && (s[t] = i));
         return s;
      }),
      C.extend({
      ...
      (E = ae.setDocument = function (e) {
         ...
         return (
            i !== T &&
               ...
               (h.matchesSelector = J.test((c = s.matches || s.webkitMatchesSelector || s.mozMatchesSelector || s.oMatchesSelector || s.msMatchesSelector))) &&
                  ce(function (e) {
         ...
         preFilter: {
            ...
            PSEUDO: function (e) {
               ...
               return K.CHILD.test(e[0])
                  ? null
                  : (e[3] ? (e[2] = e[4] || e[5] || "") : n && V.test(n) && (t = p(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && ((e[0] = e[0].slice(0, t)), (e[2] = n.slice(0, t))), e.slice(0, 3));
            },
         },
         filter: {
            TAG: function (e) {
               ...
               ? ("none" === n && ((u[c] = X.get(i, "display") || null), u[c] || (i.style.display = "")),
                 "" === i.style.display &&
                    ...
                    (u[c] =
                       ...
                       (s = (r = i).ownerDocument),
                       (a = r.nodeName),
                       (l = ce[a]) || ((o = s.body.appendChild(s.createElement(a))), (l = C.css(o, "display")), o.parentNode.removeChild(o), "none" === l && (l = "block"), (ce[a] = l)))))
   ...
   function we(e, t, n, i, r) {
      ...
      for (f.textContent = "", h = 0; (o = d[h++]); )
         ...
         else if (((u = oe(o)), (s = me(f.appendChild(o), "script")), u && ve(s), n)) for (c = 0; (o = s[c++]); ) pe.test(o.type || "") && n.push(o);
      return f;
   }
            ...
            for (u = s[s.length - 1].ownerDocument, C.map(s, Pe), c = 0; c < a; c++)
               (l = s[c]),
                  pe.test(l.type || "") &&
                     ...
                     C.contains(u, l) &&
                     (l.src && "module" !== (l.type || "").toLowerCase() ? C._evalUrl && !l.noModule && C._evalUrl(l.src, { nonce: l.nonce || l.getAttribute("nonce") }) : _(l.textContent.replace(Le, ""), l, u));
      }
      return n;
   }
   function Me(e, t, n) {
   ...
   C.extend({
      ...
      clone: function (e, t, n) {
         ...
         if (t)
            if (n) for (o = o || me(e), s = s || me(c), i = 0, r = o.length; i < r; i++) Re(o[i], s[i]);
            else Re(e, c);
   ...
   function et(e, t, n, i, r, o) {
      ...
      for (; s < 4; s += 2)
         "margin" === n && (l += C.css(e, n + ie[s], !0, r)),
            i
               ? ("content" === n && (l -= C.css(e, "padding" + ie[s], !0, r)), "margin" !== n && (l -= C.css(e, "border" + ie[s] + "Width", !0, r)))
               : ((l += C.css(e, "padding" + ie[s], !0, r)), "padding" !== n ? (l += C.css(e, "border" + ie[s] + "Width", !0, r)) : (a += C.css(e, "border" + ie[s] + "Width", !0, r)));
   ...
   function tt(e, t, n) {
      ...
      return (
         ((!v.boxSizingReliable() && r) || "auto" === s || (!parseFloat(s) && "inline" === C.css(e, "display", !1, i))) && e.getClientRects().length && ((r = "border-box" === C.css(e, "boxSizing", !1, i)), (o = a in e) && (s = e[a])),
         ...
         function (e, t, n) {
            ...
            if ((l = !C.isEmptyObject(t)) || !C.isEmptyObject(h))
               for (i in (f &&
                  ...
                  "none" === (c = C.css(e, "display")) && (u ? (c = u) : (fe([e], !0), (u = e.style.display || u), (c = C.css(e, "display")), fe([e]))),
         ...
         attr: function (e, t, n) {
            ...
            if (3 !== o && 8 !== o && 2 !== o)
               return void 0 === e.getAttribute
                  ? C.prop(e, t, n)
                  : ((1 === o && C.isXMLDoc(e)) || (r = C.attrHooks[t.toLowerCase()] || (C.expr.match.bool.test(t) ? pt : void 0)),
                    void 0 !== n
                       ? null === n
   ...
   C.fn.extend({
      ...
      C.extend({
         prop: function (e, t, n) {
            ...
            if (3 !== o && 8 !== o && 2 !== o)
               return (
                  (1 === o && C.isXMLDoc(e)) || ((t = C.propFix[t] || t), (r = C.propHooks[t])), void 0 !== n ? (r && "set" in r && void 0 !== (i = r.set(e, n, t)) ? i : (e[t] = n)) : r && "get" in r && null !== (i = r.get(e, t)) ? i : e[t]
               );
         },
         propHooks: {
            tabIndex: {
      ...
      C.fn.extend({
         ...
         toggleClass: function (r, t) {
            ...
            return "boolean" == typeof t && s
               ...
               : this.each(function () {
                    var e, t, n, i;
                    if (s) for (t = 0, n = C(this), i = _t(r); (e = i[t++]); ) n.hasClass(e) ? n.removeClass(e) : n.addClass(e);
         ...
         ajax: function (e, t) {
            ...
            m.hasContent
               ...
               : ((o = m.url.slice(f.length)),
                 m.data && (m.processData || "string" == typeof m.data) && ((f += (St.test(f) ? "&" : "?") + m.data), delete m.data),
                 !1 === m.cache && ((f = f.replace(jt, "$1")), (o = (St.test(f) ? "&" : "?") + "_=" + Ct++ + o)),
                 (m.url = f + o)),
                     ...
                     return function () {
                        o &&
                           ...
                           "abort" === e
                              ...
                              : t(Qt[i.status] || i.status, i.statusText, "text" !== (i.responseType || "text") || "string" != typeof i.responseText ? { binary: i.response } : { text: i.responseText }, i.getAllResponseHeaders()));
                     };
                  }),
                     (i.onload = o()),
   ...
   C.ajaxSetup({
      ...
      (v.createHTMLDocument = ((($t = x.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>"), 2 === $t.childNodes.length)),
      (C.parseHTML = function (e, t, n) {
         return "string" != typeof e
            ...
            : ("boolean" == typeof t && ((n = t), (t = !1)),
              ...
              (o = !n && []),
              (r = N.exec(e)) ? [t.createElement(r[1])] : ((r = we([e], t, o)), o && o.length && C(o).remove(), C.merge([], r.childNodes)));
         var i, r, o;
      }),
               ...
               (e._addTouchEventListeners = function () {
                  ...
                  if (this._touchSupported) {
                     var t = function (e) {
                        ...
                        i = function (e) {
                           n._pointerEvent && ue[e.originalEvent.pointerType.toUpperCase()] && (n.touchDeltaX = e.originalEvent.clientX - n.touchStartX),
                              n._handleSwipe(),
            ...
            return (
               ...
               (e.show = function () {
                  ...
                  if (
                     ...
                     (this._parent &&
                        0 ===
                           (e = [].slice.call(this._parent.querySelectorAll(xe)).filter(function (e) {
                              return "string" == typeof n._config.parent ? e.getAttribute("data-parent") === n._config.parent : e.classList.contains(be);
                           })).length &&
                        (e = null),
                     !(e && (t = p(e).not(this._selector).data(de)) && t._isTransitioning))
                  ) {
                     ...
                     return (
                        E.forEach(function (e, t) {
                           ...
                           (s || f || g) &&
                              ...
                              (m.placement = b + (w ? "-" + w : "")),
                              (m.offsets.popper = $e({}, m.offsets.popper, it(m.instance.popper, m.offsets.reference, m.placement))),
                  ...
                  fn: function (e, t) {
                     ...
                     var s,
                        ...
                        x =
                           ...
                           (b = a ? f : h),
                           { left: (y = a ? (m || v || p % 2 == g % 2 ? f : d) : h)(p % 2 == 1 && g % 2 == 1 && !v && a ? u.left - 1 : u.left), top: b(u.top), bottom: b(u.bottom), right: y(u.right) }),
                        ...
                        return function () {
                           if (!this.state.isDestroyed) {
                              ...
                              (e.offsets.reference = et(this.state, this.popper, this.reference, this.options.positionFixed)),
                                 (e.placement = Ze(this.options.placement, e.offsets.reference, this.popper, this.reference, this.options.modifiers.flip.boundariesElement, this.options.modifiers.flip.padding)),
                                 (e.originalPlacement = e.placement),
                                 (e.positionFixed = this.options.positionFixed),
                                 (e.offsets.popper = it(this.popper, e.offsets.reference, e.placement)),
         ...
         Gt = (function () {
            ...
            return (
                     ...
                     if ((p(i).trigger(n), !n.isDefaultPrevented())) {
                        if (!this._inNavbar && e) {
                           ...
                           "parent" === this._config.reference ? (r = i) : g.isElement(this._config.reference) && ((r = this._config.reference), void 0 !== this._config.reference.jquery && (r = this._config.reference[0])),
                              "scrollParent" !== this._config.boundary && p(i).addClass(Rt),
                              (this._popper = new Tt(r, this._menu, this._getPopperConfig()));
                        }
                        "ontouchstart" in document.documentElement && 0 === p(i).closest(Ft).length && p(document.body).children().on("mouseover", null, p.noop),
                           this._element.focus(),
               ...
               (u._dataApiKeydownHandler = function (e) {
                  if (
                     (/input|textarea/i.test(e.target.tagName) ? !(32 === e.which || (27 !== e.which && ((40 !== e.which && 38 !== e.which) || p(e.target).closest(Wt).length))) : Nt.test(e.which)) &&
                     (e.preventDefault(), e.stopPropagation(), !this.disabled && !p(this).hasClass(kt))
                  ) {
            ...
            return (
               ...
               (e._showElement = function (e) {
                  ...
                  (this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE) || document.body.appendChild(this._element),
                     ...
                     p(this._dialog).hasClass(sn) && i ? (i.scrollTop = 0) : (this._element.scrollTop = 0),
            ...
            return (
               ...
               (e.show = function () {
                  ...
                  if (this.isWithContent() && this._isEnabled) {
                     ...
                     p(r).data(this.constructor.DATA_KEY, this),
                        ...
                        (this._popper = new Tt(this.element, r, this._getPopperConfig(a))),
                        p(r).addClass(Mn),
               ...
               (e.hide = function (e) {
                  var t = this,
                     ...
                     r = function () {
                        t._hoverState !== Hn && n.parentNode && n.parentNode.removeChild(n),
                           t._cleanTipClass(),
               ...
               (e.setElementContent = function (e, t) {
                  "object" != typeof t || (!t.nodeType && !t.jquery)
                     ? this.config.html
                        ? (this.config.sanitize && (t = xn(t, this.config.whiteList, this.config.sanitizeFn)), e.html(t))
                        : e.text(t)
                     : this.config.html
         ...
         Si = (function () {
            function n(e, t) {
               ...
               (this._element = e),
                  ...
                  (this._config = this._getConfig(t)),
                  (this._selector = this._config.target + " " + yi + "," + this._config.target + " " + _i + "," + this._config.target + " " + Ei),
                  (this._offsets = []),
                  (this._targets = []),
               ...
               this.each(function () {
                  ...
                  if (d.parent().hasClass(A.wrapperClass)) {
                     ...
                     y.css(_),
                        ...
                        T(),
                        "bottom" === A.start ? (b.css({ top: d.outerHeight() - b.outerHeight() }), E(0, !0)) : "top" !== A.start && (E(D(A.start).position().top, null, !0), A.alwaysVisible || b.hide()),
                        (v = this),
                  ...
                  function E(e, t, n) {
                     ...
                     if (
                        (t && ((i = parseInt(b.css("top")) + ((e * parseInt(A.wheelStep)) / 100) * b.outerHeight()), (i = Math.min(Math.max(i, 0), r)), (i = 0 < e ? Math.ceil(i) : Math.floor(i)), b.css({ top: i + "px" })),
         ...
         (t.ripple = function (e, t) {
            ...
            if ((((t = t || {}).wait = t.wait || 0), (t.position = t.position || null), n))
               for (
                  ...
                  if (
                     ((i = e[a]), (r = t.position || { x: i.clientWidth / 2, y: i.clientHeight / 2 }), (o = f(i)), (s.x = o.left + r.x), (s.y = o.top + r.y), (l.pageX = s.x), (l.pageY = s.y), h.show(l, i), 0 <= t.wait && null !== t.wait)
                  ) {
               ...
               for (var s in this.waypoints[r]) {
                  ...
                  f.element !== f.element.window && (p = f.adapter.offset()[o.offsetProp]),
                     ...
                     !g && l && u
                        ...
                        : g && o.oldScroll >= f.triggerPoint && (f.queueTrigger(o.forward), (i[f.group.id] = f.group));
               }
            }
            return (
   ...
   (function (v) {
      ...
      v.fn.counterUp = function (e) {
         var g,
            m = v.extend({ time: 400, delay: 10, offset: 100, beginAt: 0, formatter: !1, context: "window", callback: function () {} }, e);
         return this.each(function () {
            var h = v(this),
               p = {
                     ...
                     h.data("counterup-func", function () {
                        h.data("counterup-nums")
                           ? (h.html(h.data("counterup-nums").shift()),
                             h.data("counterup-nums").length ? setTimeout(h.data("counterup-func"), p.delay) : (h.data("counterup-nums", null), h.data("counterup-func", null), m.callback.call(this)))
